...
import com.Ahmed.AhmedSpring.entity.JobPostActivity;
import com.Ahmed.AhmedSpring.entity.RecruiterJobsDto;
import com.Ahmed.AhmedSpring.entity.RecruiterProfile;
import com.Ahmed.AhmedSpring.entity.Users;
import com.Ahmed.AhmedSpring.services.JobPostActivityService;
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                List<RecruiterJobsDto> recruiterJobs =
                        jobPostActivityService
                                .getRecruiterJobs(Math.toIntExact(((RecruiterProfile) currentUserProfile).getUserAccountId()));
